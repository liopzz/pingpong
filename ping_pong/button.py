...
class Button():
    def __init__(self,x=0,y=0,height=10,width=10,text='default',
        text_color=(255,255,255),normal_color =(3, 252, 186),hover_color=(66, 135, 245),
        center_x=True,font_name=('EightBits.ttf'),font_size=20,border_radius=10
    ):
